...
public class St900ProtocolDecoder extends BaseProtocolDecoder {

    public St900ProtocolDecoder(Protocol protocol) {
        super(protocol);
    }
    ...
    private Position decodeText(String sentence, Channel channel, SocketAddress remoteAddress) {
        ...
        if (parser.hasNext()) {
            ...
            if (validity.equals("V")) {
                // Ignore messages with V validity (invalid position)
                return null;
            }
