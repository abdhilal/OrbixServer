...
public class St900ProtocolEncoder extends StringProtocolEncoder {

    private static final String MARKER = "HQ";

    public St900ProtocolEncoder(Protocol protocol) {
        super(protocol);
    }

    private Object formatCommand(Date time, String uniqueId, String type, String... params) {

        StringBuilder result = new StringBuilder(String.format("*%s,%s,%s", MARKER, uniqueId, type));
    ...
    protected Object encodeCommand(Command command, Date time) {
        ...
        switch (command.getType()) {
            ...
            case Command.TYPE_ENGINE_STOP:
                return formatCommand(time, uniqueId, "S20", "1", "3", "10", "3", "5", "3", "5", "3", "5");
